...
import com.tripled.talentlyapp.database.repositories.PortfolioRepository.PortfolioRepository
import com.tripled.talentlyapp.database.repositories.ProfileRepository.IProfileRepository
import org.springframework.web.socket.WebSocketSession
import java.lang.Exception

class PopularByCategoryOperation(private val request: MobileRequest, private val session: WebSocketSession,
                                 private val portfolioRepository: IPortfolioRepository, private val category: String) : Runnable {

    override fun run() {
        synchronized(session) {
            try {
                val data = Portfolios(portfolioRepository.getPopularByCategory(category))
