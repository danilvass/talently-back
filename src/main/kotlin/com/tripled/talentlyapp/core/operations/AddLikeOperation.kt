...
import com.tripled.talentlyapp.core.network.ws.models.requests.data.LikeRequestData
...
class AddLikeOperation(private val requestType: MobileRequestType, private val requestId: String,
                       private val accountId: String, private val addLikeData: LikeRequestData,
                       private val session: WebSocketSession, private val postRepository: IPostRepository) : Runnable {
    override fun run() {
        synchronized(session) {
            try {
                postRepository.addLike(accountId,addLikeData.postId)
